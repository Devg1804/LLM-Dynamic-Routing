"""
Contains the PyTorch nn.Module definitions for the NVIDIA Prompt Classifier.
This module defines the neural network architecture but does not handle
loading or inference logic, which is managed by the classifier_service.
"""
